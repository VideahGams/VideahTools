...
function input.load()
	...
	--Camera Movement
	input:bind(loadedSettings.controls.forward, "camera.forward")
	input:bind(loadedSettings.controls.backward, "camera.backward")
	input:bind(loadedSettings.controls.left, "camera.left")
	input:bind(loadedSettings.controls.right, "camera.right")
